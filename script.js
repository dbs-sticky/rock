...
// function getHumanChoice() { // get the human choice
...
function playRound(humanSelect, computerSelect) { // function to play a single round, include rock, paper, scissors logic
    ...
    if (humanSelect === computerSelect) { // the case when it's a draw
        ...
        const para = document.createElement("p");
        const score = scoreBoard.appendChild(para);
        score.textContent =`You also selected ${humanSelect} It was a draw`;
        ...
        const para = document.createElement("p");
        const score = scoreBoard.appendChild(para);
        score.textContent =`You selected ${humanSelect} You win!`;
        ...
        const para = document.createElement("p");
        const score = scoreBoard.appendChild(para);
        score.textContent =`You selected ${humanSelect} You lose!`;
    } else {
